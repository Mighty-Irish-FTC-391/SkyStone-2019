...
public class MagnumDrive extends LinearOpMode {
    ...
    public final double[][] PIDF_ARM = {
            {15.0,3.0,0.0,0.0}, //upper arm
            {15.0,3.0,0.0,0.0} //lower arm
    };
    ...
    public void runOpMode(){
        ...
        lowerArm.setDirection(DcMotorSimple.Direction.FORWARD);
        upperArm.setDirection(DcMotorSimple.Direction.FORWARD);
        ...
        if(PIDF_MECH != null) {
            lowerArm.setVelocityPIDFCoefficients(PIDF_ARM[0][1], PIDF_ARM[0][1], PIDF_ARM[0][2], PIDF_ARM[0][3]);
            upperArm.setVelocityPIDFCoefficients(PIDF_ARM[1][1], PIDF_ARM[1][1], PIDF_ARM[1][2], PIDF_ARM[1][3]);
        }
        //Servos for the main arm & pincer
        ...
        while(opModeIsActive()){
            ...
            waffleLeft.setPosition(gamepad1.a ? (waffleLeft.getPosition() > 0.9 ? 0.0 : 1.0) : waffleLeft.getPosition());
            ...
            telemetry.addData("upArm Speed Error", upperArm.getVelocity(AngleUnit.DEGREES)+", "+targUpSpeed);
            telemetry.addData("lowArm Speed Error", lowerArm.getVelocity(AngleUnit.DEGREES)+", "+targDownSpeed);
