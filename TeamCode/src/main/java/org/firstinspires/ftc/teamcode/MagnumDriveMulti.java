...
public class MagnumDriveMulti extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            //double craneXdrive = gamepad2.dpad_right ? 1.0 : gamepad2.dpad_left ? -1.0 : 0;
            //double craneYdrive = gamepad2.dpad_up ? 1.0 : gamepad2.dpad_down ? -1.0 : 0;

            double[] coeffs= mechanumPower(
                    -(1.0-DRIVER_RATIO)*gamepad1.left_stick_x + DRIVER_RATIO*gamepad2.left_stick_y,
                    (1.0-DRIVER_RATIO)*gamepad1.left_stick_y + DRIVER_RATIO*gamepad2.left_stick_x,
                    (1.0-DRIVER_RATIO)*gamepad1.right_stick_x + DRIVER_RATIO*gamepad2.right_stick_x);
            ...
            //move gripper
            backGrip.setPosition(gamepad2.left_trigger);
            frontGrip.setPosition(1.0-gamepad2.right_trigger);
